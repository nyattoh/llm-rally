...
例）
1. 2026年のフィジカルAIの動向を予測してください
2. ネコと鉛筆を題材に、ボケとツッコミに分かれて漫才をしてください
3. 右クリックメニューからwordファイルの文章と画像を取り出すアプリを協業して作ってください
4. 黒猫探偵を主人公にしたミステリー小説を3,000文字程度で書いてブラッシュアップしてください
5. 多くの人が困っているけれど細かすぎて気付かないことを10個挙げてその対策をキャッチコピーとして100案つくってください
6. {URL}にある論文を精査して、核心となる論点について議論してください
7. Xの最新アルゴリズムを検索して、パーソナライズデータから投稿案を1週間分出してブラッシュアップしてください
など
